"""
Django settings for arc_community project.
...
ROOT_URLCONF = 'arc_community.urls'
...
WSGI_APPLICATION = 'arc_community.wsgi.application'
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'arc-community-aglz'
...
STRIPE_HALF_YEAR_ID = os.getenv('STRIPE_HALF_YEAR_ID', '')
